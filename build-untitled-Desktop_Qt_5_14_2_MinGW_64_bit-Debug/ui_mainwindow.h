...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        cBox_SerialPortNum->setGeometry(QRect(675, 65, 100, 25));
        cBox_SerialPortNum->setEditable(false);
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(575, 205, 85, 25));
        QFont font;
        ...
        label_4->setGeometry(QRect(575, 275, 85, 25));
        ...
        CBox_SerialPortcheck->setGeometry(QRect(675, 275, 100, 25));
        opencolse = new QPushButton(centralwidget);
        opencolse->setObjectName(QString::fromUtf8("opencolse"));
        opencolse->setGeometry(QRect(560, 400, 100, 35));
        opencolse->setFont(font);
        label = new QLabel(centralwidget);
        label->setObjectName(QString::fromUtf8("label"));
        label->setGeometry(QRect(575, 65, 80, 25));
        label->setFont(font);
        label_5 = new QLabel(centralwidget);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(575, 345, 100, 25));
        ...
        cBox_SerialPortDataNum->setGeometry(QRect(675, 205, 100, 25));
        cBox_SerialPortDataNum->setEditable(false);
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(575, 135, 85, 25));
        ...
        cBox_SerialPortStopBit->setGeometry(QRect(675, 345, 100, 25));
        ...
        cBox_SerialPortBaud->setGeometry(QRect(675, 135, 100, 25));
        cBox_SerialPortBaud->setEditable(false);
        label_6 = new QLabel(centralwidget);
        label_6->setObjectName(QString::fromUtf8("label_6"));
        label_6->setGeometry(QRect(560, 30, 100, 20));
        ...
        bt_clearsend->setGeometry(QRect(380, 290, 111, 31));
        ...
        bt_sendserialdata->setGeometry(QRect(560, 510, 71, 28));
        bt_sendserialdata->setFont(font1);
        cb_sendhex = new QCheckBox(centralwidget);
        cb_sendhex->setObjectName(QString::fromUtf8("cb_sendhex"));
        cb_sendhex->setGeometry(QRect(680, 510, 111, 19));
        cb_rechex = new QCheckBox(centralwidget);
        cb_rechex->setObjectName(QString::fromUtf8("cb_rechex"));
        cb_rechex->setGeometry(QRect(680, 470, 111, 19));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        bt_sendserialdata->setText(QCoreApplication::translate("MainWindow", "\345\217\221\351\200\201", nullptr));
        cb_sendhex->setText(QCoreApplication::translate("MainWindow", "16\350\277\233\345\210\266\345\217\221\351\200\201", nullptr));
        cb_rechex->setText(QCoreApplication::translate("MainWindow", "16\350\277\233\345\210\266\346\230\276\347\244\272", nullptr));
    } // retranslateUi
